 ...
 *
 * @author Taki21(code) @ StarPE Project
 * @author TheKnightGamer(php) @ StarPE Project
 * @since StarPE 1.0 | StarPE API 1.0.0
 */
public class StarPE {
    ...
    public final static String MINECRAFT_VERSION = "v0.14.0 alpha";
    public final static String MINECRAFT_VERSION_NETWORK = "0.14.0";
    ...
    public static void main(String[] args) {
        ...
        try {
            if (ANSI) {
                System.out.print((char) 0x1b + "]0;Starting StarPE Server For Minecraft: PE" + (char) 0x07);
            }
